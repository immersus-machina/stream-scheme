...
internal static class XlsxXml
{
    ...
    internal static ReadOnlySpan<byte> WorkbookBeforeSheetName =>
        "<?xml version=\"1.0\" encoding=\"utf-8\"?><workbook xmlns=\"http://schemas.openxmlformats.org/spreadsheetml/2006/main\" xmlns:r=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships\"><sheets><sheet name=\""u8;

    internal static ReadOnlySpan<byte> WorkbookAfterSheetName =>
        "\" sheetId=\"1\" r:id=\"rId1\"/></sheets></workbook>"u8;
